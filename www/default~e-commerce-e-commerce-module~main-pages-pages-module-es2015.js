...
function MatExpansionPanelHeader_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r425 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"]();
...
class UsuarioService {
    ...
    getUsuario(nick) {
        return new Promise(resolve => {
            this.http.get(this.apiUrl + '/usuario/' + nick, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Authorization': 'Bearer ' + localStorage.getItem('tokenUsuario') }) }).subscribe(data => {
                resolve(data);
    ...
    getCuentosId(idCuento) {
        return new Promise(resolve => {
            this.http.get(this.apiUrl + '/cuentos/' + idCuento, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Authorization': 'Bearer ' + localStorage.getItem('tokenUsuario') }) }).subscribe(data => {
                resolve(data);
            }, err => {
                console.log(err);
            });
    ...
    getCuentos() {
        return new Promise(resolve => {
            this.http.get(this.apiUrl + '/cuentos', { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Authorization': 'Bearer ' + localStorage.getItem('tokenUsuario') }) }).subscribe(data => {
                resolve(data);
            }, err => {
                console.log(err);
            });
    ...
    getEstudiante(nickUsuario) {
        return new Promise(resolve => {
            this.http.get(this.apiUrl + '/estudiante/' + nickUsuario, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Authorization': 'Bearer ' + localStorage.getItem('tokenUsuario') }) }).subscribe(data => {
                resolve(data);
            }, err => {
                console.log(err);
            });
    ...
    saveCalificacionEstudiante(estudianteId, calificacionId) {
        const param = {
            estudianteId,
            calificacionId
        };
        return new Promise((resolve, reject) => {
            this.http.post(this.apiUrl + '/estudianteCalificacion', param, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Authorization': 'Bearer ' + localStorage.getItem('tokenUsuario') }) })
                .subscribe(res => {
                resolve(res);
            }, (err) => {
                reject(err);
    ...
    getEstudianteId(idEstudiante) {
        return new Promise(resolve => {
            this.http.get(this.apiUrl + '/estudiante/id/' + idEstudiante, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Authorization': 'Bearer ' + localStorage.getItem('tokenUsuario') }) }).subscribe(data => {
                resolve(data);
            }, err => {
                console.log(err);
            });
    ...
    getPuntajeFonoloficaId() {
        ...
        return new Promise(resolve => {
            this.http.get(this.apiUrl + '/puntaje/' + this.idpuntajeFonologico, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Authorization': 'Bearer ' + localStorage.getItem('tokenUsuario') }) }).subscribe(data => {
                resolve(data);
                console.log(data);
            }, err => {
                console.log(err);
    ...
    getPuntajeVisualId() {
        return new Promise(resolve => {
            this.http.get(this.apiUrl + '/puntaje/' + _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].idPuntaje, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Authorization': 'Bearer ' + localStorage.getItem('tokenUsuario') }) }).subscribe(data => {
                resolve(data);
            }, err => {
                console.log(err);
            });
    ...
    savePuntajeEstudiante(estudianteId, puntajeId) {
        const param = {
            estudianteId,
            puntajeId
        };
        return new Promise((resolve, reject) => {
            this.http.post(this.apiUrl + '/estudiantePuntaje', param, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Authorization': 'Bearer ' + localStorage.getItem('tokenUsuario') }) })
                .subscribe(res => {
                resolve(res);
            }, (err) => {
                reject(err);
    ...
    postCalificaciones(calificacion) {
        return new Promise((resolve, reject) => {
            this.http.post(this.apiUrl + '/calificaciones', calificacion, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Authorization': 'Bearer ' + localStorage.getItem('tokenUsuario') }) })
                .subscribe(res => {
                resolve(res);
            }, (err) => {
                reject(err);
    ...
    postPuntaje(puntaje, detalle) {
        ...
        return new Promise((resolve, reject) => {
            this.http.post(this.apiUrl + '/puntaje', param, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Authorization': 'Bearer ' + localStorage.getItem('tokenUsuario') }) })
                .subscribe(res => {
                resolve(res);
            }, (err) => {
                reject(err);
    ...
    postAgenda(fecha, fecha_fin, nombre, hora_inicio, hora_fin, ubicacion, etiqueta, descripcion) {
        ...
        return new Promise((resolve, reject) => {
            this.http.post(this.apiUrl + '/agenda', param, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Authorization': 'Bearer ' + localStorage.getItem('tokenUsuario') }) })
                .subscribe(res => {
                resolve(res);
            }, (err) => {
                reject(err);
    ...
    saveAgendaProfesor(usuarioId, agendaId) {
        const param = {
            usuarioId,
            agendaId
        };
        return new Promise((resolve, reject) => {
            this.http.post(this.apiUrl + '/agendaProfesor', param, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Authorization': 'Bearer ' + localStorage.getItem('tokenUsuario') }) })
                .subscribe(res => {
                resolve(res);
            }, (err) => {
                reject(err);
    ...
    uploadFile(file) {
        ...
        return this.http.post(urlServicios, formData, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Authorization': 'Bearer ' + localStorage.getItem('tokenUsuario') }) });
    }
}
